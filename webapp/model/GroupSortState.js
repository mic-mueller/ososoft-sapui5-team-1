sap.ui.define([
	...
	return BaseObject.extend("de.ososoft.team1.purchase_order.model.GroupSortState", {
		 ...
		 * @alias de.ososoft.team1.purchase_order.model.GroupSortState
		 */
		...
		/**
		 * Sorts by PoNumber, or by NetValue
		 *
		...
		/**
		 * Groups by NetValue, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "NetValue") {
				...
				this._oViewModel.setProperty("/sortBy", "NetValue");
				...
				this._oViewModel.setProperty("/sortBy", "PoNumber");
			}

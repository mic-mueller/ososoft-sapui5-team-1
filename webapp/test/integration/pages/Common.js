sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/ososoft/team1/purchase_order/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("de.ososoft.team1.purchase_order.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["de/ososoft/team1/purchase_order/localService/mockserver"], function (mockserver) {

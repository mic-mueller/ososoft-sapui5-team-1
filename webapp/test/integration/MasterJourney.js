...
sap.ui.define([
	...
	opaTest("MasterList Filtering on NetValue less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<NetValue>").
	...
	opaTest("MasterList Filtering on NetValue more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Currency>").
			and.iPressOKInViewSelectionDialog();

...
sap.ui.define([
		...
		"de/ososoft/team1/purchase_order/model/grouper",
		...
		return BaseController.extend("de.ososoft.team1.purchase_order.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("de.ososoft.team1.purchase_order.view.ViewSettingsDialog", this);
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("PoNumber");
